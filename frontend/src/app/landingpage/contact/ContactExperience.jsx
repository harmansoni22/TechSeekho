        ...
        <>
            ...
            >
                ...
                >
                    ...
                    >
                        Tell us where you are stuck and where you want to go. We
                        will guide you with clear next steps.
                    </motion.p>
                ...
                <section className="grid gap-10 py-12 lg:grid-cols-[1.05fr_0.95fr]">
                    ...
                    >
                        ...
                        <form className="mt-7 space-y-5">
                            ...
                            <label
                                ref={topicMenuRef}
                                className="float-field relative block"
                            >
                                <input
                                    type="hidden"
                                    name="topic"
                    ...
                    >
                        ...
                        >
                            ...
                            <p className="mt-3 text-sm leading-7 text-white/72">
                                If you are deciding between services, check the
                                services page and then message us. We will help
