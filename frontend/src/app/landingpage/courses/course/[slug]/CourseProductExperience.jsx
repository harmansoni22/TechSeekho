        ...
        () => [
            {
                ...
                rating: 5,
                quote: "The sessions were practical and easy to follow. I finally became consistent with projects.",
            },
            {
                id: "r2",
                name: "Meera Joshi",
                ...
                rating: 5,
                quote: "Mentor feedback was clear and direct. I fixed weak areas quickly and gained confidence.",
            },
            {
                id: "r3",
                name: "Rohan Verma",
                ...
                rating: 5,
                quote: "What I liked most was the structure. Every week had a clear target and useful output.",
            },
        ],
        [],
    );
                ...
                >
                    ...
                    >
                        ...
                        <p className="mt-5 max-w-md text-base leading-8 text-white/72">
                            You can quickly understand what starts when, how
                            long it runs, and what support you get before
                            joining.
                        </p>
                        <Link
                    ...
                    >
                        <div>
                            ...
                            <h3 className="mt-3 max-w-xl text-[clamp(1.6rem,3.6vw,2.6rem)] font-semibold leading-[1.04] tracking-[-0.03em] text-white">
                                Build real skills with a clear, structured
                                learning path.
                            </h3>
                        </div>
                        {/* <Link
