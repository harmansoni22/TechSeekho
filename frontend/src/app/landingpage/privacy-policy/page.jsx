...
export const metadata = {
  ...
  description:
    "Review how TechSeekho collects, uses, and protects your personal information.",
};
      ...
      <main className="mx-auto mt-25 w-full max-w-4xl px-4 pb-20 text-white">
        ...
        <div className="mt-8 space-y-7 text-sm leading-7 text-white/85">
          <section>
            ...
            <p className="mt-2">
              We may collect your name, email address, phone number, course
              interests, and payment details needed to process enrollments and
              provide support.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              We use your data to manage accounts, deliver courses, communicate
              important updates, process transactions, and improve our learning
              experience.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-medium text-white">3. Data Sharing</h2>
            <p className="mt-2">
              We do not sell personal data. We may share limited information
              with trusted service providers for payments, communication, and
              analytics as required to operate our platform.
            </p>
          </section>
