        ...
        <section className="mx-auto w-full max-w-7xl">
          ...
          >
            ...
            >
              ...
              <span className="text-white/84">{service.title}</span>
            </motion.nav>
          ...
          >
            ...
            >
              ...
              <p className="mt-4 text-base leading-8 text-white/74">
                Choose this if you want structure, practical tasks, and regular
                feedback to improve your execution quickly.
              </p>
              <p className="mt-6 text-sm leading-7 text-white/62">
                If you are not sure, message our team and we will help you pick
                the right service based on your current level and target role.
              </p>
            </motion.aside>
          </section>
