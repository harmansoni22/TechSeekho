...
const quickLinks = [
  ...
  { label: "Services", href: "/landingpage/services" },
  { label: "Courses", href: "/landingpage/courses" },
...
const featuredCourses = [
  {
    label: "Python With AI",
    href: "/landingpage/courses/course/python-with-ai",
  },
  {
    label: "Frontend Development",
    href: "/landingpage/courses/course/frontend-web-development",
  },
  {
    label: "Backend Development",
    href: "/landingpage/courses/course/backend-web-development",
  },
  {
    label: "Generative AI",
    href: "/landingpage/courses/course/generative-ai",
  },
];
      ...
      <div className="relative mx-auto w-full max-w-7xl px-4 py-12 sm:px-6 sm:py-14 lg:px-8 lg:py-16">
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
          <div className="space-y-4">
            ...
            <p className="text-sm leading-6 text-white/80">
              Learn practical skills in web development, AI, and modern software
              engineering with project-based guidance.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm text-white/80">
              {quickLinks.map((item) => (
                <li key={item.href}>
                  <Link href={item.href} className="underline-animation">
                    {item.label}
                  </Link>
                </li>
              ))}
        ...
        <div className="mt-10 border-t border-white/15 pt-6">
          <div className="flex flex-col gap-3 text-xs text-white/70 sm:flex-row sm:items-center sm:justify-between">
            <p>&copy; {currentYear} TechSeekho. All rights reserved.</p>
