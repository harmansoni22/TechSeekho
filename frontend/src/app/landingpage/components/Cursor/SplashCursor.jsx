...
//   TRANSPARENT = true,
//   INTERACTIVE_SELECTOR = 'a, button, [role="button"], input, select, textarea, summary, [data-fluid-interactive]',
    ...
    useEffect(() => {
      ...
      `,
        ...
        function handleInteractiveClick(event) {
            const interactiveElement = getInteractiveElement(event.target);
            if (!interactiveElement) return;
            emitBurstFromElement(
                interactiveElement,
                interactiveClickForce,
                5,
                0.1,
            );
        }
