...
const FlowField = () => {
  ...
  useEffect(() => {
    ...
    function getColor(noiseValue, alpha) {
      ...
      const h =
        colorPalette[i1].h + t * (colorPalette[i2].h - colorPalette[i1].h);
      const s =
        colorPalette[i1].s + t * (colorPalette[i2].s - colorPalette[i1].s);
      const l =
        colorPalette[i1].l + t * (colorPalette[i2].l - colorPalette[i1].l);
    ...
    function animate() {
      ...
      for (const particle of particles) {
        ...
        const angle = perlin.fbm(noiseX, noiseY, time, 4, 2, 0.5) * Math.PI * 4;
