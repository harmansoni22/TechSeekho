...
const ProfileCardComponent = ({
  ...
  const grainStyle = {
    transform: "translate3d(0, 0, 0.8px)",
    overflow: "hidden",
    ...
    >
      {behindGlowEnabled && (
        <div
          ...
          style={{
            backgroundImage: `radial-gradient(circle at var(--pointer-x) var(--pointer-y), var(--behind-glow-color) 0%, transparent var(--behind-glow-size))`,
