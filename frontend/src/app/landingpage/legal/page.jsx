        ...
        <>
            ...
            <main className="mx-auto mt-25 w-full max-w-5xl px-4 pb-20 text-white">
                ...
                <p className="mx-auto mt-4 max-w-3xl text-center text-sm leading-7 text-white/75">
                    Browse all legal documents for TechSeekho. Use these pages
                    to understand your rights, responsibilities, and policies
                    related to enrollments and platform usage.
                </p>
