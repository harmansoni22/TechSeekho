...
export default function PendingApprovalPage() {
	...
	const [reason, setReason] = useState("Your institutional access is being verified.");

	useEffect(() => {
		// UX-only. Backend remains source of truth.
		const timeout = setTimeout(() => {
			setReason("You will be able to access the dashboard once your institution approves your onboarding.");
		}, 600);
